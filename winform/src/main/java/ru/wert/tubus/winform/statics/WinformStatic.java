...
public class WinformStatic {
    ...
    public static String CURRENT_PROJECT_VERSION = "6.9.1"; //Версия приложения обновляется вручную
    public static String VERSION_CREATED_DATE = "02.07.2024"; //Дата выпуска версии
