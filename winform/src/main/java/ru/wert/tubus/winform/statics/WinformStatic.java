...
public class WinformStatic {
    ...
    public static String CURRENT_PROJECT_VERSION = "7.4"; //Версия приложения обновляется вручную
    public static String VERSION_CREATED_DATE = "30.06.2025"; //Дата выпуска версии
