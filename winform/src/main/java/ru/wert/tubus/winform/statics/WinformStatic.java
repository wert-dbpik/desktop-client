...
public class WinformStatic {
    ...
    public static String CURRENT_PROJECT_VERSION = "6.5"; //Версия приложения обновляется вручную
    public static String VERSION_CREATED_DATE = "15.02.2024"; //Дата выпуска версии
