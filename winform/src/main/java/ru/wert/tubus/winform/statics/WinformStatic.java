...
public class WinformStatic {
    ...
    public static String CURRENT_PROJECT_VERSION = "6.7"; //Версия приложения обновляется вручную
    public static String VERSION_CREATED_DATE = "15.03.2024"; //Дата выпуска версии
