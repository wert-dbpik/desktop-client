...
public class WinformStatic {
    ...
    public static String CURRENT_PROJECT_VERSION = "7.0"; //Версия приложения обновляется вручную
    public static String VERSION_CREATED_DATE = "12.02.2025"; //Дата выпуска версии
