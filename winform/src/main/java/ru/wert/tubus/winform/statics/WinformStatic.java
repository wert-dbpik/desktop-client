...
public class WinformStatic {
    ...
    public static String CURRENT_PROJECT_VERSION = "7.2"; //Версия приложения обновляется вручную
    public static String VERSION_CREATED_DATE = "26.06.2025"; //Дата выпуска версии
