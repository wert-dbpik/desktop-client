package ru.wert.tubus.winform.window_decoration;
...
//===========================================    НАЧАЛО     ========================================================
    ...
    @FXML
    void initialize(){
        logo.setImage(new Image(WindowDecorationController.class.getResourceAsStream("/winform-piсs/logo_sun.png"), 16,  16, true, true));
    }
...
//===========================================    СОБЫТИЯ МЫШИ     =====================================================
    ...
    private void changeSizeOfWindow(Stage window, MouseEvent e) {
        ...
        if (isExpanded) {
            ...
            ModalWindow.centerWindow(window, WinformStatic.WF_MAIN_STAGE, e);
            isExpanded = false;
        } else {
