  ...
  _createClass(ViewHistory, [{
    ...
    value: function _writeToStorage() {
      ...
      return new Promise(function (resolve) {
        ...
        localStorage.setItem('pdfjs-2.3.200.history', databaseStr);
        resolve();
      });
    }
  }, {
    ...
    value: function _readFromStorage() {
      return new Promise(function (resolve) {
        resolve(localStorage.getItem('pdfjs-2.3.200.history'));
      });
    }
  }, {
    key: 'set',
...
var GenericPreferences = function (_BasePreferences) {
  ...
  _createClass(GenericPreferences, [{
    ...
    value: function _writeToStorage(prefObj) {
      return new Promise(function (resolve) {
        localStorage.setItem('pdfjs-2.3.200.preferences', JSON.stringify(prefObj));
        resolve();
      });
    }
  }, {
    ...
    value: function _readFromStorage(prefObj) {
      return new Promise(function (resolve) {
        var readPrefs = JSON.parse(localStorage.getItem('pdfjs-2.3.200.preferences'));
        resolve(readPrefs);
      });
    }
  }]);
...
var DownloadManager = function () {
  ...
  _createClass(DownloadManager, [{
    ...
    value: function downloadUrl(url, filename) {
      ...
      _download(url + '#pdfjs-2.3.200.action=download', filename);
    }
  }, {
    key: 'downloadData',
