...
import ru.wert.tubus.chogori.entities.folders.commands.Folder_DeleteCommand;
import ru.wert.tubus.chogori.entities.product_groups.ProductGroup_TreeView;
import ru.wert.tubus.chogori.entities.product_groups.commands.ProductGroup_DeleteCommand;
import ru.wert.tubus.chogori.entities.product_groups.commands._ProductGroup_Commands;

import java.util.ArrayList;
import java.util.List;

import static ru.wert.tubus.chogori.application.services.ChogoriServices.CH_FOLDERS;
