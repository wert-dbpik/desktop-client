package ru.wert.tubus.chogori.excel.poi;
...
public class POIReader {
    ...
    public POIReader(File file) throws IOException {
        ...
        this.colLaсquerExist = setOfColNames.contains(EColName.LACQUER.toString());
        this.colZpcExist = setOfColNames.contains(EColName.ZCP.toString());
        this.colAmountPerAssembleExist = setOfColNames.contains(EColName.AMOUNT.toString());
