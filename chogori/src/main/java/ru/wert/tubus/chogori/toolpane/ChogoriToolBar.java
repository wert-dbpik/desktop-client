package ru.wert.tubus.chogori.toolpane;
...
import ru.wert.tubus.chogori.common.interfaces.BaseCommands;
...
public class ChogoriToolBar extends ToolBar {
    ...
    public static final Image BTN_ADD_IMG = new Image(BtnImages.class.getResourceAsStream("/chogori-pics/toolpane/add(24x24).png"));
    public static final String BTN_ADD_TOOLTIP = "Добавить чертежи";
    //ДОБАВИТЬ ПАПКУ
    public static Button BTN_ADD_FEW;
    public static final Image BTN_ADD_FEW_IMG = new Image(BtnImages.class.getResourceAsStream("/chogori-pics/toolpane/addFolder(24x24).png"));
    public static final String BTN_ADD_FEW_TOOLTIP = "Добавить папку";
    //ДОБАВИТЬ КОПИРОВАНИЕМ
    public static Button BTN_COPY;
    public static final Image BTN_COPY_IMG = new Image(BtnImages.class.getResourceAsStream("/chogori-pics/toolpane/copy(24x24).png"));
    public static final String BTN_COPY_TOOLTIP = "Добавить копированием";
    //ИЗМЕНИТЬ
    public static Button BTN_CHANGE;
    public static final Image BTN_CHANGE_IMG = new Image(BtnImages.class.getResourceAsStream("/chogori-pics/toolpane/change(24x24).png"));
    public static final String BTN_CHANGE_TOOLTIP = "Изменить";
    //УДАЛИТЬ
    public static Button BTN_DELETE;
    public static final Image BTN_DELETE_IMG = new Image(BtnImages.class.getResourceAsStream("/chogori-pics/toolpane/delete(24x24).png"));
