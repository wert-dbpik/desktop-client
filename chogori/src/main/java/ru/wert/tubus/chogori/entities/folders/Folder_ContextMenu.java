...
public class Folder_ContextMenu extends FormView_ContextMenu<Folder> {
    ...
    public void createMainMenuItems() {
        ...
        boolean noSearchAndGlobal = !(CH_SEARCH_FIELD.getSearchedTableView() instanceof Folder_TableView);
    ...
    public List<MenuItem> createExtraItems(){
        ...
        productGroup_commands = new _ProductGroup_Commands(treeView, tableView, ChogoriServices.CH_FOLDERS);
