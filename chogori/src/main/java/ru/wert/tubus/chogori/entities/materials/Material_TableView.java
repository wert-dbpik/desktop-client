...
import ru.wert.tubus.chogori.entities.materials.commands._Material_Commands;
...
public class Material_TableView extends CatalogTableView<Material, MaterialGroup> {
    ...
    private static final String accWindowRes = "/chogori-fxml/materials/materialACC.fxml";
    ...
    public List<Material> prepareList() {
        ...
        if(modifyingClass instanceof MaterialGroup){
            if(modifyingItem == null)
                list = ChogoriServices.CH_MATERIALS.findAll();
            else {
