...
import ru.wert.tubus.chogori.excel.enums.EColName;
import ru.wert.tubus.chogori.excel.enums.EColor;
import ru.wert.tubus.chogori.excel.model.EditorRow;
import ru.wert.tubus.chogori.images.EditorImages;
...
import static ru.wert.tubus.chogori.excel.enums.EColor.*;
import static ru.wert.tubus.chogori.excel.table.TableMaster.findTableColumnById;
import static ru.wert.tubus.chogori.excel.table.TableMaster.getAllColumns;
...
public class Excel_ContextMenu extends ContextMenu {
    ...
    public Excel_ContextMenu(TableView<EditorRow> tv) {
        ...
        MenuItem noColor = new MenuItem("Без цвета", new ImageView(EditorImages.WHITE_SQ_IMG));
        noColor.setOnAction(e -> changeColor(WHITE));

        MenuItem greenColor = new MenuItem("Зеленый", new ImageView(EditorImages.GREEN_SQ_IMG));
        greenColor.setOnAction(e -> changeColor(GREEN));

        MenuItem blackColor = new MenuItem("Черный", new ImageView(EditorImages.BLACK_SQ_IMG));
        blackColor.setOnAction(e -> changeColor(BLACK));

        MenuItem orangeColor = new MenuItem("Оранжевый", new ImageView(EditorImages.ORANGE_SQ_IMG));
        orangeColor.setOnAction(e -> changeColor(ORANGE));

        MenuItem yellowColor = new MenuItem("Желтый", new ImageView(EditorImages.YELLOW_SQ_IMG));
        yellowColor.setOnAction(e -> changeColor(YELLOW));

        MenuItem blueColor = new MenuItem("Голубой", new ImageView(EditorImages.BLUE_SQ_IMG));
