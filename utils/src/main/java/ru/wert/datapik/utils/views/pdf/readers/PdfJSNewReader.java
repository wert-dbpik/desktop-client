package ru.wert.datapik.utils.views.pdf.readers;
...
public class PdfJSNewReader implements PDFReader {
    ...
    public PdfJSNewReader(StackPane stackPaneForPDF) {
        ...
        String url = getClass().getResource("/utils-pdfjs/pdfjs-2.6.347/viewer.html").toExternalForm();
        engine.setUserStyleSheetLocation(getClass().getResource("/utils-pdfjs/pdfjs-2.6.347/viewer.css").toExternalForm());
