...
public class PdfJSOldReader implements PDFReader {
    ...
    public PdfJSOldReader(StackPane stackPaneForPDF) {
        ...
        String url = getClass().getResource("/utils-pdfjs/pdfjs-2.3.200/viewer.html").toExternalForm();
        //We add our stylesheet.
        engine.setUserStyleSheetLocation(getClass().getResource("/utils-pdfjs/pdfjs-2.3.200/viewer.css").toExternalForm());
