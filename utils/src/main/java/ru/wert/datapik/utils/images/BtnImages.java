...
public class BtnImages {
    ...
    public static Image BTN_ALT_TRUE_IMG = new Image(BtnImages.class.getResourceAsStream("/utils-pics/btns/alt-white(32x32).png"));
    public static Image BTN_ALT_FALSE_IMG = new Image(BtnImages.class.getResourceAsStream("/utils-pics/btns/alt-black(32x32).png"));
