...
public class _ProductGroup_TreeViewPatch<P extends Item> {
    ...
    public ProductGroup_TreeView<P> create(ItemService<P> dependedItemService){
        ...
        ProductGroup_TreeView<P> catalogTreeView = new ProductGroup_TreeView<>(CH_PRODUCT_GROUPS, dependedItemService, rootProductGroup, useContextMenu);
